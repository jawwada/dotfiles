...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default "M-m")
   dotspacemacs-emacs-leader-key "<f6>"
   ...
   dotspn `spacemacs/prettify-org-buffer' when
